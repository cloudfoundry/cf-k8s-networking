...
kubectl create serviceaccount -n webhook-demo sa-injector
kubectl create clusterrolebinding sa-injector --clusterrole=cluster-admin -n webhook-demo --serviceaccount=webhook-demo:sa-injector
