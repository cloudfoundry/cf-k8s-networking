...
template_story=`curl -s -X GET -H "X-TrackerToken: $TRACKER_TOKEN" "https://www.pivotaltracker.com/services/v5/projects/$project_id/stories/174851272" | sed -E "s|X\.X\.X|${ISTIO_VERSION}|" | jq '. + {"current_state": "started"}'`
